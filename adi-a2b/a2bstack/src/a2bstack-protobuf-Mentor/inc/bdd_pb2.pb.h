...
#define bdd_NodeDescriptor_init_default          {0, 0, 0}
#define bdd_CtrlRegs_init_default                {false, 0, false, 0, false, 0, 0, 0, 0, false, 0, false, 0, false, 0, false, 0, false, 0}
...
#define bdd_I2cI2sRegs_init_default              {0, false, 0, 0, 0, false, 0, false, 0, false, 0, false, 0, 0, 0, false, 0, false, 0, false, 0, false, 0}
#define bdd_PinIoRegs_init_default               {false, 0, 0, 0, 0, 0, 0, 0, false, 0, false, 0}
...
#define bdd_NetworkPolicy_init_default           {(bdd_DiscoveryMode)0, (bdd_ConfigMethod)0, (bdd_ConfigPriority)0, (bdd_ConfigErrPolicy)0}
#define bdd_Network_init_default                 {bdd_MetaData_init_default, 0, bdd_NetworkPolicy_init_default, 0, {bdd_Node_init_default, bdd_Node_init_default, bdd_Node_init_default, bdd_Node_init_default, bdd_Node_init_default, bdd_Node_init_default, bdd_Node_init_default, bdd_Node_init_default, bdd_Node_init_default, bdd_Node_init_default}, 0, {bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default, bdd_Stream_init_default}, 0}
#define bdd_MetaData_init_zero                   {0, 0, false, "", false, "", false, "", false, 0}
#define bdd_NodeDescriptor_init_zero             {0, 0, 0}
#define bdd_CtrlRegs_init_zero                   {false, 0, false, 0, false, 0, 0, 0, 0, false, 0, false, 0, false, 0, false, 0, false, 0}
...
#define bdd_I2cI2sRegs_init_zero                 {0, false, 0, 0, 0, false, 0, false, 0, false, 0, false, 0, 0, 0, false, 0, false, 0, false, 0, false, 0}
#define bdd_PinIoRegs_init_zero                  {false, 0, 0, 0, 0, 0, 0, 0, false, 0, false, 0}
...
#define bdd_NetworkPolicy_init_zero              {(bdd_DiscoveryMode)0, (bdd_ConfigMethod)0, (bdd_ConfigPriority)0, (bdd_ConfigErrPolicy)0}
#define bdd_Network_init_zero                    {bdd_MetaData_init_zero, 0, bdd_NetworkPolicy_init_zero, 0, {bdd_Node_init_zero, bdd_Node_init_zero, bdd_Node_init_zero, bdd_Node_init_zero, bdd_Node_init_zero, bdd_Node_init_zero, bdd_Node_init_zero, bdd_Node_init_zero, bdd_Node_init_zero, bdd_Node_init_zero}, 0, {bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero, bdd_Stream_init_zero}, 0}
...
#define bdd_CtrlRegs_swctl_tag                   10
#define bdd_CtrlRegs_control_tag                 11
...
extern const pb_field_t bdd_NodeDescriptor_fields[4];
extern const pb_field_t bdd_CtrlRegs_fields[12];
...
extern const pb_field_t bdd_NetworkPolicy_fields[5];
extern const pb_field_t bdd_Network_fields[7];

/* Maximum encoded size of messages (where known) */
#define bdd_MetaData_size                        214
#define bdd_NodeDescriptor_size                  18
#define bdd_CtrlRegs_size                        66
...
#define bdd_Node_size                            839
#define bdd_NetworkPolicy_size                   24
#define bdd_Network_size                         11107
