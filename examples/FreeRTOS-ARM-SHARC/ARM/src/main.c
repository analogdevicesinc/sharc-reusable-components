...
/* SHARC / ARM IPC struct */
SHARC_ARM_IPC sharcArmIPC __attribute__ ((section(".mcapi_data_icc")));
...
static portTASK_FUNCTION( startupTask, pvParameters )
{
    ...
    /* Tell the SHARC that the system is ready */
    sharcArmIPC.armInitComplete = 1;
...
int main(int argc, char *argv[])
{
    ...
    /* Clear out the ARM / SHARC IPC struct */
    memset(&sharcArmIPC, 0, sizeof(sharcArmIPC));
