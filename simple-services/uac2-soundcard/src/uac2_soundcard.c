...
static CLD_SC58x_Audio_2_0_Lib_Init_Params uac2_init_params =
{
...
CLD_RV uac2_start(void)
{
    ...
    do {
        cld_rv = cld_sc58x_audio_2_0_lib_init(&uac2_init_params);
