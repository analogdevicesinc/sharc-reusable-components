...
/*=============================================================================
    FILE:           cld_sc57x_audio_2_0_w_cdc_lib.h

    DESCRIPTION:    CLD Audio v2.0 with CDC peripheral Library.

    Copyright (c) 20198 Closed Loop Design, LLC
 ...
 *            CLD USB Audio 2.0 and CDC/ACM library using the SC57x's Cortex-A5 processor.
 *
 *            Copyright (c) 2019 Closed Loop Design, LLC
 *
 *            This software is supplied "AS IS" without any warranties, express, implied
 *            or statutory, including but not limited to the implied warranties of fitness
 *            for purpose, satisfactory quality and non-infringement. Closed Loop Design LLC
...
typedef enum
{
    CLD_SC57x_CDC_NETWORK_DISCONNECTED    = 0,
    CLD_SC57x_CDC_NETWORK_CONNECTED       = 1,
} CLD_SC57x_CDC_Lib_Network_Connection_State;
...
#define CLD_SC57x_CDC_LINE_CODING_1_STOP_BITS             0 /*<! CDC Line Coding: 1 Stop Bit */
#define CLD_SC57x_CDC_LINE_CODING_1_5_STOP_BITS           1 /*<! CDC Line Coding: 1.5 Stop Bits */
#define CLD_SC57x_CDC_LINE_CODING_2_STOP_BITS             2 /*<! CDC Line Coding: 2 Stop Bits */

#define CLD_SC57x_CDC_LINE_CODING_PARITY_NONE             0 /*<! CDC Line Coding: No Parity */
#define CLD_SC57x_CDC_LINE_CODING_PARITY_ODD              1 /*<! CDC Line Coding: Odd Parity */
#define CLD_SC57x_CDC_LINE_CODING_PARITY_EVEN             2 /*<! CDC Line Coding: Even Parity */
#define CLD_SC57x_CDC_LINE_CODING_PARITY_MARK             3 /*<! CDC Line Coding: Force Mark */
#define CLD_SC57x_CDC_LINE_CODING_PARITY_SPACE            4 /*<! CDC Line Coding: Force Space */

#define CLD_SC57x_CDC_LINE_CODING_NUM_DATA_BITS_5         5 /*<! CDC Line Coding: 5 data Bits */
#define CLD_SC57x_CDC_LINE_CODING_NUM_DATA_BITS_6         6 /*<! CDC Line Coding: 6 data Bits */
#define CLD_SC57x_CDC_LINE_CODING_NUM_DATA_BITS_7         7 /*<! CDC Line Coding: 7 data Bits */
#define CLD_SC57x_CDC_LINE_CODING_NUM_DATA_BITS_8         8 /*<! CDC Line Coding: 8 data Bits */
#define CLD_SC57x_CDC_LINE_CODING_NUM_DATA_BITS_16        16 /*<! CDC Line Coding: 16 data Bits */
...
typedef struct
{
    ...
    CLD_SC57x_Audio_2_0_Audio_Stream_Data_Endpoint_Descriptor * p_audio_stream_endpoint_data_descriptor; /*!< Pointer to the Audio Stream endpoint data descriptor */
...
} CLD_SC57x_Audio_2_0_Control_Interrupt_Params;
...
typedef struct
{
    CLD_SC57x_Audio_2_0_Requests    req;                    /*!< bRequest value of the active command */
...
} CLD_SC57x_Audio_2_0_w_CDC_Lib_User_String_Descriptors;
...
typedef struct
{
    ...
    CLD_SC57x_Audio_2_0_Control_Interrupt_Params * p_audio_control_interrupt_params; /*!< Pointer to the optional Control Interface Interrupt IN endpoint.
    ...
    CLD_SC57x_Audio_2_0_Stream_Interface_Params * p_audio_streaming_rx_interface_params; /*!< Pointer to the interface parameters
    ...
    /* Pointer to the Optional Audio Stream RX Isochronous OUT's rate Feedback Isochonous IN interface.
       Set to CLD_NULL if not required.*/
    CLD_SC57x_Audio_2_0_Rate_Feedback_Params * p_audio_rate_feedback_rx_params;

    CLD_SC57x_Audio_2_0_Stream_Interface_Params * p_audio_streaming_tx_interface_params; /*!< Pointer to the interface parameters
     ...
     * @param p_req_param - Pointer to the CLD_SC57x_Audio_2_0_Cmd_Req_Parameters for the current Control Endpoint Set request
     ...
     * @return Notifies the CLD Library if the received command should be accepted, stalled, paused, or discarded */
    CLD_USB_Transfer_Request_Return_Type (*fp_audio_set_req_cmd) (CLD_SC57x_Audio_2_0_Cmd_Req_Parameters * p_req_params, CLD_USB_Transfer_Params * p_transfer_data);
     ...
     * @param p_req_param - Pointer to the CLD_SC57x_Audio_2_0_Cmd_Req_Parameters for the current Control Endpoint Get request
     * @param p_transfer_data - Pointer to the CLD_USB_Transfer_Params structure used to define the data to send to the USB Host.
     * @return Notifies the CLD Library if the received command should be accepted, stalled, paused, or discarded */
    CLD_USB_Transfer_Request_Return_Type (*fp_audio_get_req_cmd) (CLD_SC57x_Audio_2_0_Cmd_Req_Parameters * p_req_params, CLD_USB_Transfer_Params * p_transfer_data);
     ...
     */
    CLD_SC57x_CDC_Notification_Endpoint_Params * p_notification_endpoint_params;
    ...
    * should configure its UART parameters based on the CLD_SC57x_CDC_Line_Coding
    * structure passed to the function.
    *
    * <b>Set to CLD_NULL if not supported.</b>
    * @param p_line_coding - Pointer to the CLD_SC57x_CDC_Line_Coding structure with the line coding defined by the USB Host.
    * @return Notifies the CLD Library if the received command should be accepted, stalled, paused, or discarded
    */
    CLD_USB_Data_Received_Return_Type (*fp_cdc_cmd_set_line_coding) (CLD_SC57x_CDC_Line_Coding * p_line_coding);

   /**
    * Function called when an CDC Get Line Coding Command is received. The User code
    * should load the CLD_SC57x_CDC_Line_Coding structure passed to the function with
    * the current line coding values.
    *
    * <b>Set to CLD_NULL if not supported.</b>
    * @param p_line_coding - Pointer to the CLD_SC57x_CDC_Line_Coding structure with the line coding values to send to the USB Host.
    * @return CLD_SUCCESS- line coding values updated, CLD_FAIL - Line coding values were not updated.
    */
    CLD_RV (*fp_cdc_cmd_get_line_coding) (CLD_SC57x_CDC_Line_Coding * p_line_coding);

   /**
    * Function called when an CDC Set Control Line State Command is received.
    * The User code should process the CLD_SC57x_CDC_Control_Line_State structure
    * passed to the function.
    *
    * <b>Set to CLD_NULL if not supported.</b>
    * @param p_control_line_state - Pointer to the CLD_SC57x_CDC_Control_Line_State structure with the control line state defined by the USB Host.
    * @return Notifies the CLD Library if the received command should be accepted, stalled, paused, or discarded
    */
    CLD_USB_Data_Received_Return_Type (*fp_cdc_cmd_set_control_line_state) (CLD_SC57x_CDC_Control_Line_State * p_control_line_state);
   ...
   */
    CLD_SC57x_Audio_2_0_w_CDC_Lib_User_String_Descriptors * p_user_string_descriptor_table;
 ...
 * @param cld_sc57x_audio_2_0_w_cdc_lib_params - Pointer to the CLD library initialization parameters,
 * @return The status of the library initialization (CLD_SUCCESS, CLD_FAIL, CLD_ONGOING).
 */
extern CLD_RV cld_sc57x_audio_2_0_w_cdc_lib_init (CLD_SC57x_Audio_2_0_w_CDC_Lib_Init_Params * cld_sc57x_audio_2_0_w_cdc_lib_params);
 ...
 */
extern void cld_sc57x_audio_2_0_w_cdc_lib_main (void);
 ...
 */
extern CLD_USB_Data_Transmit_Return_Type cld_sc57x_audio_2_0_w_cdc_lib_transmit_audio_data (CLD_USB_Transfer_Params * p_transfer_data);
 ...
 * @return If the requested transmission was successfully initiated or if it failed..
 */
extern CLD_USB_Data_Transmit_Return_Type cld_sc57x_audio_2_0_w_cdc_lib_transmit_interrupt_data (CLD_USB_Transfer_Params * p_transfer_data);
 ...
 * @return If the requested transmission was successfully initiated or if it failed..
 */
extern CLD_USB_Data_Transmit_Return_Type cld_sc57x_audio_2_0_w_cdc_lib_transmit_audio_rate_feedback_data (CLD_USB_Audio_Feedback_Params * p_transfer_data);
 ...
 */
extern void cld_sc57x_audio_2_0_w_cdc_lib_resume_paused_audio_data_transfer (void);
 ...
 * @return If the requested transmission was successfully initiated or if it failed..
 */
extern CLD_USB_Data_Transmit_Return_Type cld_sc57x_cdc_lib_transmit_serial_data (CLD_USB_Transfer_Params * p_transfer_data);

/**
 * Function used to transmit the Network Connection notification using the CDC Interrupt IN endpoint.
 * @param CLD_SC57x_CDC_Lib_Network_Connection_State - The CLD_SC58x_CDC_Lib_Network_Connection_State to send to the USB Host.
 * @return If the requested transmission was successfully initiated or if it failed..
 */
extern CLD_USB_Data_Transmit_Return_Type cld_sc57x_cdc_lib_send_network_connection_state (CLD_SC57x_CDC_Lib_Network_Connection_State state);

/**
 * Function used to transmit the Response Available notification using the CDC Interrupt IN endpoint.
 * @return If the requested transmission was successfully initiated or if it failed..
 */
extern CLD_USB_Data_Transmit_Return_Type cld_sc57x_cdc_lib_send_response_available (void);
 ...
 * @param p_serial_state - Pointer to the CLD_SC57x_CDC_Serial_State structure describing the serial state being transmitted.
 * @return If the requested transmission was successfully initiated or if it failed..
 */
extern CLD_USB_Data_Transmit_Return_Type cld_sc57x_cdc_lib_send_serial_state (CLD_SC57x_CDC_Serial_State * p_serial_state);
 ...
 * accept, discard or stall the previously paused transfer.
 */
extern void cld_sc57x_audio_2_0_w_cdc_lib_resume_paused_serial_data_transfer (void);
 ...
 * accept, discard or stall the previously paused transfer.
 */
extern void cld_sc57x_audio_2_0_w_cdc_lib_resume_paused_control_transfer (void);
